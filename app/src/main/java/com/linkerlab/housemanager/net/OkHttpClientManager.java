...
public class OkHttpClientManager {
     ...
     * @param url
     */
    private Response _getAsynheader(String url, String param) throws IOException {
        final Request request = new Request.Builder()
                .url(url)
                .addHeader("Authorization", "Bearer " + param)
                .build();
        Call call = mOkHttpClient.newCall(request);
        Response execute = call.execute();
        return execute;
    ...
    public static String getToken(String url, String params) throws IOException {
        return getInstance()._getAsynheaderAsString(url, params);
    }
